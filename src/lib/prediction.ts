...
export function predictRisk(input: PredictionInput): RiskForecast {
  ...
  const factors: RiskFactor[] = [
    ...
    { key: "risky-weekday", label: `Risky weekday (${DOW_NAMES[nowDow]})`, weight: 11, active: riskyWeekday,
      detail: `Today is a ${DOW_NAMES[nowDow]} — your past relapses cluster on this weekday`, suggestion: "Add structure to today specifically." },
